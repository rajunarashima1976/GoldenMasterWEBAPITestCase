using AutoMapper;
using GoldenMasterCodeProj.WEBAPI.Controllers;
using GoldenMasterCodeProj.WEBAPI.EntityModel;
using GoldenMasterCodeProj.WEBAPI.NewFolder;
...
namespace GoldenMasterApi.UnitTest
{
    [TestFixture]
